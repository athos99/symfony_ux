Symfony v8.1.1 (env: dev, debug: true)
...
Available commands:
 ...
 doctrine
  ...
  doctrine:debug:entity-listeners            Lists entity listeners for a given entity
  doctrine:debug:event-manager               Lists event listeners for an entity manager
 ...
 tailwind
  tailwind:build                             Builds the Tailwind CSS assets.
  tailwind:init                              Initializes Tailwind CSS for your project
  tailwind:update                            Updates the Tailwind CSS binary to the latest version within the current major
 translation
